...
class FAISS(VannaBase):
    def __init__(self, config=None):
        ...
        from common.Common_cn import MyEmbeddingsModel
        self.embedding_model = MyEmbeddingsModel().get_DashScope_embeddings_model()
    ...
    def generate_embedding(self, data: str, **kwargs) -> List[float]:
        print(f"Generating embedding for: {data}")

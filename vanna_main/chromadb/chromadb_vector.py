...
openai_ef = embedding_functions.OpenAIEmbeddingFunction(
    api_base=my_config.embedding_api_base,
    api_key=my_config.embedding_api_key,
    model_name=my_config.embedding_model_name
)
...
class ChromaDB_VectorStore(VannaBase):
    def __init__(self, config=None):
        ...
        path = config.get("path", my_config.vanna_db_path)
